...
/**
 *  Created by chenkehao on 2017/7/14.
 */
...
public class DBService {
    ...
    public DBService() {
        //连接数据
        db = SQLiteDatabase.openDatabase(LilacTestsApp.getContext().getFilesDir().getPath()+"/databases/question.db",
    ...
    public List<Question> getQuestion() {
        ...
        if (cursor.getCount() > 0) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                //问题
                question.subject = cursor.getString(cursor.getColumnIndex("Field2"));
                //四个选择
                ...
                //解析
                question.explanation = cursor.getString(cursor.getColumnIndex("Field8"));
                //设置为没有选择任何选项
